...
const CONFIG = require(args['--config-file'] ? args['--config-file'] : '../.blockotus.json');
const EXEC_DIR = path.basename(path.resolve(process.cwd()));
const CWD_SCRIPTS = EXEC_DIR === 'scripts' ? './' : './scripts';
